                        ...
                        <tr>
                            ...
                            <td><div class="btn-group dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    ...
                                    <a class="dropdown-item " href="{{ route('role.edit',['id'=> $role->id]) }}" type="submit"><i class="mdi mdi-pencil m-r-10 text-muted font-18 vertical-middle"></i>Edit Role</a>
                                    <a class="dropdown-item " href="{{ route('role.delete',['id'=> $role->id]) }}" type="submit"><i class="mdi mdi-delete m-r-10 text-muted font-18 vertical-middle"></i>Delete Role</a>                                  
                                </div>
                            </div>
                        </td>
                        @endforeach
